...
def geocode(query: str) -> tuple[tuple[float, float], str] | None:
    """Возвращает ((lon, lat), полный_адрес) или None."""
    params = {
...
class MapWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.address_edit.setPlaceholderText("Здесь появится адрес найденного объекта")
